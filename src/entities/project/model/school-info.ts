...
export const directions: DanceDirection[] = [
  ...
  },
  {
    ...
    description:
      'Помимо занятий собираемся на **самостоятельные практики**, **вечеринки** и **опен-эйры**, а также специальные события. Это пространство, где можно **танцевать больше** и находить своих людей.',
  },
]
